...
#include <math.h>
StateBottomRandom::StateBottomRandom(Config conf) : MState(conf), m_countIteration(0), m_validChanges(0), m_invalidChanges(0), m_skipBecauseOfWeight(0)
{
}
